...
# Inject overlay directly into pos-cart-scroll-zone (covers items, summary, and customer data)
qris_overlay = """
...
content = content.replace('<div class="pos-cart-scroll-zone">', '<div class="pos-cart-scroll-zone" style="position:relative;">\n' + qris_overlay)
...
content = content.replace('const qrisOverlay = document.getElementById("posQrisOverlay");', 'const qrisOverlay = document.getElementById("posQrisOverlay");\n    const posQrisImg = document.getElementById("posQrisImg");\n    if(posQrisImg) posQrisImg.src = qrisSrc;')
